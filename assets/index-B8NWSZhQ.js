...
//#endregion
//#region src/assets/Mastercard.svg
...
//#endregion
//#region src/assets/visa-logo.svg
...
//#endregion
//#region src/components/preview/CardNetworkBrand.tsx
var import_jsx_runtime = (/* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_react_jsx_runtime_production();
})))();
function CardNetworkBrand({ networkBrand }) {
	const selectBrandImage = (brand) => {
		if (brand === "visa") return visa_logo_default;
		if (brand === "master") return Mastercard_default;
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardNetworkBrandContainer, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
...
`;
//#endregion
//#region src/components/preview/CardNumber.tsx
function CardNumber() {
	const { cardNumber } = (0, import_react.useContext)(CardContext);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardNumberContainer, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: cardNumber["first-digits"] }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: cardNumber["second-digits"] }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "secret",
			children: "●".repeat(cardNumber["third-digits"].length)
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "secret",
			children: "●".repeat(cardNumber["fourth-digits"].length)
		})
	] });
}
...
`;
//#endregion
//#region src/components/preview/CardExpiryDate.tsx
function CardExpiryDate() {
	const { cardExpiryDate } = (0, import_react.useContext)(CardContext);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardExpiryDateContainer, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: cardExpiryDate["expiry-month"] }),
		cardExpiryDate["expiry-month"].length === 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: " / " }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: cardExpiryDate["expiry-year"] })
	] });
}
...
`;
//#endregion
//#region src/components/preview/CardPreview.tsx
function CardPreview() {
	const { networkBrand } = (0, import_react.useContext)(CardContext);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContainer$1, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "card-meta",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ic-chip" }), networkBrand && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardNetworkBrand, { networkBrand })]
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "card-contents",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardNumber, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardExpiryDate, {})]
	})] });
}
...
`;
//#endregion
//#region src/components/form/CardSection.tsx
function CardSection({ title, subTitle, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardSectionContainer, { children: [
...
`;
//#endregion
//#region src/components/form/ErrorMessage.tsx
function ErrorMessage({ message }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorMessageContainer, { children: message });
}
var ErrorMessageContainer = styled.p`
  color: #ff3d3d;
  font-size: 9.5px;
  height: 1rem;
`;
//#endregion
//#region src/validators/CardValidator.ts
var Validator = {
	isNumber(value) {
		if (Number.isNaN(Number(value))) throw new Error("숫자만 입력 가능합니다.");
	},
	isValidNetworkBrand(value) {
		if (value !== "" && !["4", "5"].includes(value[0])) throw new Error("유효한 카드 번호가 아닙니다. 카드 번호는 4 또는 5로 시작해야합니다.");
		if (value.length === 2 && value[0] === "5" && ![
			"1",
			"2",
			"3",
			"4",
			"5"
		].includes(value[1])) throw new Error("마스터카드 번호는 51 ~ 55 사이 숫자로 시작해야 합니다.");
	},
	isValidCardNumberLength(value, limit) {
		if (![0, limit].includes(value.length)) throw new Error("카드 번호 각 항목은 4자리여야 합니다.");
	},
	isValidMonth(value) {
	...
	isValidYear(value) {
		...
		const year = value;
		if (year.length === 2 && Number(year) < Number(currentYear)) throw new Error("유효기간이 만료된 연도입니다.");
	},
	isValidCardExpiryDateLength(value, limit) {
		if (![0, limit].includes(value.length)) throw new Error("날짜 각 항목은 2자리여야 합니다.");
	},
	isValidCardCVCLength(value, limit) {
		if (![0, limit].includes(value.length)) throw new Error("CVC는 3자리여야 합니다.");
	}
};
//#endregion
...
`;
//#endregion
//#region src/components/form/CardNumberInput.tsx
function CardNumberInput() {
	const { cardNumber, setCardNumber, setNetworkBrand } = (0, import_react.useContext)(CardContext);
	const [isError, setError] = (0, import_react.useState)({
	...
	const handleNetworkBrand = (value) => {
	...
	const changeFirstDigitsCardNumber = (e) => {
		const { value, id } = e.target;
		try {
			Validator.isNumber(value);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardFieldset, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardLegend, { children: "카드 번호" }),
	...
	] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ErrorMessage, { message: isError["message"] })] });
}
//#endregion
//#region src/components/form/CardExpiryDateInput.tsx
function CardExpiryDateInput() {
	const { cardExpiryDate, setCardExpiryDate } = (0, import_react.useContext)(CardContext);
	const [isError, setError] = (0, import_react.useState)({
		"expiry-month": { state: false },
		"expiry-year": { state: false },
		message: ""
	});
	const changeCardExpiryMonth = (e) => {
		const { value, id } = e.target;
		try {
			Validator.isNumber(value);
	...
	const handleBlurCardExpiryDate = (e) => {
		const { value, id } = e.target;
		try {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardFieldset, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardLegend, { children: "유효기간" }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardInput, {
			type: "text",
			inputMode: "numeric",
			id: "expiry-month",
...
//#endregion
//#region src/components/form/CardCVCInput.tsx
function CardCVCInput() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardCVCContainer, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardCVCLabel, {
...
var CardCVCContainer = styled.div`
  display: flex;
  flex-direction: column;
  gap: 0.625rem;
`;
var CardCVCLabel = styled.label`
  font-size: 12px;
`;
//#endregion
//#region src/components/form/CardForm.tsx
function CardForm() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardFormContainer, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardSection, {
			title: "결제할 카드 번호를 입력해 주세요",
			subTitle: "본인 명의의 카드만 결제 가능합니다.",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardNumberInput, {})
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardSection, {
...
var CardContext = (0, import_react.createContext)(null);
function Card() {
	...
	const [cardExpiryDate, setCardExpiryDate] = (0, import_react.useState)({
		"expiry-month": "",
		"expiry-year": ""
	});
	const [networkBrand, setNetworkBrand] = (0, import_react.useState)("");
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContext, {
		value: {
			cardNumber,
			cardExpiryDate,
			networkBrand,
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContainer, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardPreview, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardForm, {})] })
	});
}
...
//#region src/App.tsx
function App() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {}) });
}
//#endregion
//#region src/main.tsx
